...
<?php
	foreach ($this->rows as $row )
	{
		...
		if (!in_array($row->access, $groups))
		{
			...
			$lockImage = ' <img class="etTableListLockElement" src="'.JURI::root().'media/com_easytablepro/images/locked.gif" title="'. $altText .'" alt="'.JText::_('COM_EASYTABLEPRO_SITE_CLICK_TO_LOGIN').'" />';
		}
		else
		{
			$lockImage ='';
