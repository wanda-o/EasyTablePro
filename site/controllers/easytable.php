...
*/			}
	...
	function parseCSVFile (&$file)
	{
		...
		if(isset( $file['name']) && $file['name'] != '')
		{
			...
			$src = $file['tmp_name'];
			$dest = JPATH_COMPONENT . DS . "uploads" . DS . $origFilename;
	...
	function old_updateETTDTableFrom ($id, $ettdColumnAliass, $CSVFileArray)
	{
		$hasHeaders = JRequest::getVar('CSVFileHasHeaders');
		...
		$msg .='<BR />updateETTDTableFrom() $insert_ettd_data_SQL -> '.$insert_ettd_data_SQL;
